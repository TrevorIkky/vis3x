...
class SwinTransformer(nn.Module):
    ...
    def get_last_attn(self, x):
        _, attn = self.forward_features(x)
        return attn
...
def swin_tiny(patch_size=16, **kwargs):
...
def swin_small(patch_size=16, **kwargs):
    return SwinTransformer(
        patch_size=patch_size,
        embed_dim=96,
        depths=[2, 2, 18, 2],
...
def swin_base(patch_size=16, **kwargs):
    return SwinTransformer(
        patch_size=patch_size,
        embed_dim=120,
        depths=[2, 2, 18, 2],
...
def swin_large(patch_size=16, **kwargs):
    return SwinTransformer(
        patch_size=patch_size,
        embed_dim=192,
        depths=[2, 2, 18, 2],
...
if __name__ == "__main__":
    ...
    model = swin_base(4)
    output = model.get_last_attn(imgs)
