...
def train(args):
    ...
    if args.arch in vit.__dict__.keys():
        student = vit.__dict__[args.arch](args.patch_size, drop_path_rate=args.dropout_path_rate)
    ...
    student = utils.MultiCropWrapper(student, DINOHead(
        embed_dim, args.out_dim, use_bn=args.head_use_bn, norm_last_layer=args.norm_last_layer))
    ...
    dino_loss = DinoLoss(args.out_dim, args.num_local_crops + 2,
                         ...
                         args.warmup_teacher_epochs, args.epochs).cuda()
...
def train_one_epoch(args, epoch, student, teacher, teacher_without_ddp, dino_loss, optimizer,
    ...
    for it, images in enumerate(loop):
        ...
        for idx, param_group in optimizer.param_groups:
...
def get_args_parser():
    ...
    # Misc
    parser.add_argument('--data_path', default='./dataset/PCB/train/', type=str,
                        help='Please specify path to the ImageNet training data.')
    parser.add_argument('--output_dir', default="./vis3x/checkpoints", type=str,
